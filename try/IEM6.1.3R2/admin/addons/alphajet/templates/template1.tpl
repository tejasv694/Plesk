...
<head>
    ...
    .create_list_head :hover{
        cursor: pointer;
        background-color: #337AB7;
        color : #fff;
    }
    .main-row{
        /* background-image: url('css/bk.jpg'); */
    ...
    <div class="container">
        <div class="row main-row">
            <div class="panel panel-primary">
                ...
                <h3>
                    Alphainfolab Email Marketer Addon
                </h3>
                </div>
            </div>
            ...
            <div id="hr-div" class="<?php if((isset($_GET['idUser'])) && ($_GET['idUser'] != '')){ echo 'blind'; } ?>">
                <hr>
            </div>
            <div id="alertmsg"></div>
