...
$GLOBALS['Design_Rules']['Outlook 2003'] = array (
	array(
		'regular_expression' => '%(style\s*?=\s*?)(["\'])(.*?)(\s*?background-spacing\s*?:.*?)(\2|;)%',
		'description' => 'Outlook 2003 doesn\'t show the CSS style: background-spacing',
		'use_preg_replace' => 1,
		'replacement' => '$1$2$3$5',
		'match_offset' => 2
	),
	array(
		...
		'description' => 'Outlook 2003 doesn\'t show the CSS style: caption-side',
		'use_preg_replace' => 1,
		'replacement' => '$1$2$3$5',
		'match_offset' => 2
	),
	array(
		...
		'description' => 'Outlook 2003 doesn\'t show the CSS style: empty-cells',
		'use_preg_replace' => 1,
		'replacement' => '$1$2$3$5',
		'match_offset' => 2
	),
	array(
		...
		'description' => 'Outlook 2003 doesn\'t show the CSS style: opacity',
		'use_preg_replace' => 1,
		'replacement' => '$1$2$3$5',
		'match_offset' => 2
	),
	array(
		...
		'description' => 'Outlook 2003 doesn\'t show the CSS style: white-space',
		'use_preg_replace' => 1,
		'replacement' => '$1$2$3$5',
		'match_offset' => 2
	),
