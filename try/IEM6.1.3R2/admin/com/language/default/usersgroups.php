...
define('LNG_HLP_UsersGroups_Field_Access_Lists', 'Which contact lists will this client / group have access to? The permissions selected above will be applied to these lists.');
define('LNG_UsersGroups_Field_Access_Segments', 'Segment List');
define('LNG_HLP_UsersGroups_Field_Access_Segments', 'Which segments will this client / group have access to? The permissions selected above will be applied to these list');
define('LNG_UsersGroups_Field_Access_Templates', 'Templates');
define('LNG_HLP_UsersGroups_Field_Access_Templates', 'Which templates does this client / group have access to? The permissions selected above will be applied to these templates.');
define('LNG_UsersGroups_Field_Restriction_MailingList', 'Number of Contact Lists');
define('LNG_HLP_UsersGroups_Field_Restriction_MailingList', 'Set the maximum number of contact lists each user in this group may create.');
define('LNG_UsersGroups_Field_Restriction_EmailsPerHour', 'Emails Per Hour');
define('LNG_HLP_UsersGroups_Field_Restriction_EmailsPerHour', 'Set the maximum number of emails each user in this group may send per hour.');
define('LNG_UsersGroups_Field_Restriction_EmailsPerMonth', 'Emails Per Month');
define('LNG_HLP_UsersGroups_Field_Restriction_EmailsPerMonth', 'Set the maximum number of emails each user in this group may send each month. Each user account has a separate credit balance.');
define('LNG_UsersGroups_Field_Restriction_TotalEmails', 'Total Number of Emails');
define('LNG_HLP_UsersGroups_Field_Restriction_TotalEmails', 'Set the maximum number of emails each user in this group may send. This is not time limited. Each user account has a separate credit balance.');
...
define('LNG_HLP_UsersGroups_Restrictions_Lists_Finite', 'The number of contact lists each user in this group may create.');
...
define('LNG_HLP_UsersGroups_Restrictions_EmailsPerHour_Finite', 'The maximum number of emails each user in this group may send per hour.<br/><br/>If two email campaigns are scheduled in the same hour, this will not affect the total number of emails sent, it will only affect each email campaign separately.');
...
define('LNG_UsersGroups_Restrictions_ForceSpamCheck_Explain', 'Yes, force all campaigns and autoresponders to be spam checked before they may be sent');
define('LNG_UsersGroups_ManageGroups', 'User Groups');
define('LNG_UsersGroups_ManageGroups_Intro', 'A user group is a way to define a set of access permissions which may then be inherited by users. To create a new group, click the <em>Create a User Group...</em> button below.');
...
define('LNG_UsersGroups_Form_CreateGroup_Intro', 'A user group is a way to define a set of access permissions which may then be inherited by users. To create a new group, fill in the form below and click the save button.');
define('LNG_UsersGroups_Form_EditGroup', 'Edit a User Group');
define('LNG_UsersGroups_Form_EditGroup_Intro', 'A user group is a way to define a set of access permissions which may then be inherited by users.');
