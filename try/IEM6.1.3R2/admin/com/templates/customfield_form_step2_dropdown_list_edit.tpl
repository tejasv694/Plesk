...
<tr>
	<td width="200" class="FieldLabel">
		...
		{if $row_key == ''}<b>{/if}{$lang.DropDown} %%GLOBAL_KeyNumber%% {$lang.Value}:{if $row_key == ''}</b>{/if}&nbsp;
	</td>
	<td class="PickListValues">
		<input type="text" name="Value[%%GLOBAL_KeyNumber%%]" class="Field250" value="%%GLOBAL_Value%%" id="value_%%GLOBAL_KeyNumber%%">&nbsp;{$;nghlp.Checkbox_Value}
