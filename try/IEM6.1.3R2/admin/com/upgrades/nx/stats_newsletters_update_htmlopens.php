...
* @package SendStudio
*/
class stats_newsletters_update_htmlopens extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		$query = 'update ' . SENDSTUDIO_TABLEPREFIX . 'stats_newsletters set htmlopens=0, htmlopens_unique=0, textopens=0, textopens_unique=0';
