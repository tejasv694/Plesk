...
* @package SendStudio
*/
class autoresponders_change_active extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if (SENDSTUDIO_DATABASE_TYPE == 'mysql') {
			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'autoresponders change active active int';
		} else {
			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'autoresponders alter active type int using active::int';
		}
