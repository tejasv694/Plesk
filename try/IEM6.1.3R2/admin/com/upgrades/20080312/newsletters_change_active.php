...
* @package SendStudio
*/
class newsletters_change_active extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if (SENDSTUDIO_DATABASE_TYPE == 'mysql') {
			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'newsletters change active active int';
		} else {
			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'newsletters alter active type int using active::int';
		}
