...
* @package SendStudio
*/
class templates_change_isglobal extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if (SENDSTUDIO_DATABASE_TYPE == 'mysql') {
			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'templates change isglobal isglobal int';
		} else {
			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'templates alter isglobal type int using isglobal::int';
		}
