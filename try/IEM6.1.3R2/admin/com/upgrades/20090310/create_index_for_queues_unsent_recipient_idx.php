...
* @package SendStudio
*/
class create_index_for_queues_unsent_recipient_idx extends Upgrade_API
{
	/**
	 * RunUpgrde
	 * Run current upgrade
	...
	function RunUpgrade()
	{
		if (!$this->IndexExists('queues_unsent', 'recipient')) {
			...
			$status = $this->Db->Query("CREATE INDEX " . SENDSTUDIO_TABLEPREFIX . "queues_unsent_recipient_idx ON " . SENDSTUDIO_TABLEPREFIX . "queues_unsent (recipient)");
		}
