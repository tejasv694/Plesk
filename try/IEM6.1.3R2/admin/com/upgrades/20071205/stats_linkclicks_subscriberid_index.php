...
* @package SendStudio
*/
class stats_linkclicks_subscriberid_index extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->IndexExists('stats_linkclicks', 'subscriberid')) {
			return true;
		}

		$query = 'create index ' . SENDSTUDIO_TABLEPREFIX . 'stats_linkclicks_subscriberid on ' . SENDSTUDIO_TABLEPREFIX . 'stats_linkclicks(subscriberid)';
