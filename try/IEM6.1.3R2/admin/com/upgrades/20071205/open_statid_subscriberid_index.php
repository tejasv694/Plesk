...
* @package SendStudio
*/
class open_statid_subscriberid_index extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->IndexExists('stats_emailopens', array('subscriberid', 'statid'))) {
			return true;
		}

		$query = 'create index ' . SENDSTUDIO_TABLEPREFIX . 'open_statid_subscriberid on ' . SENDSTUDIO_TABLEPREFIX . 'stats_emailopens(subscriberid, statid)';
