...
* @package SendStudio
*/
class users_add_googlecalendarusername extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		...
		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'users ADD googlecalendarusername VARCHAR(255) default NULL';
