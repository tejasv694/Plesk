...
* @package SendStudio
*/
class users_add_language_preference extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('users', 'user_language')) {
			return true;
		}
		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . "users ADD COLUMN user_language VARCHAR(25) NOT NULL DEFAULT 'default'";
