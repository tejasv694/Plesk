...
* @package SendStudio
*/
class users_add_googlecalendarpassword extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		...
		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'users ADD googlecalendarpassword VARCHAR(255) default NULL';
