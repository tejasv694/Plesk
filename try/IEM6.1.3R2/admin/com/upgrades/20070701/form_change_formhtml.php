...
* @package SendStudio
*/
class form_change_formhtml extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if (SENDSTUDIO_DATABASE_TYPE == 'mysql') {
			if (!$this->ColumnExists('forms', 'formhtml')) {
				return false;
			}

			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'forms change formhtml formhtml longtext';
