...
* @package SendStudio
*/
class users_add_usewysiwyg extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('users', 'usewysiwyg')) {
			return true;
		}

		$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'users add column usewysiwyg char(1)';
