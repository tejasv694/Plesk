...
* @package SendStudio
*/
class stats_newsletters_add_htmlopens extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('stats_newsletters', 'htmlopens')) {
			return true;
		}

		$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'stats_newsletters add column htmlopens int';
