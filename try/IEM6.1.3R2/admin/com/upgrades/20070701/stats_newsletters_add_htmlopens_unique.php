...
* @package SendStudio
*/
class stats_newsletters_add_htmlopens_unique extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('stats_newsletters', 'htmlopens_unique')) {
			return true;
		}

		$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'stats_newsletters add column htmlopens_unique int';
