...
* @package SendStudio
*/
class list_add_company_address extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('lists', 'companyaddress')) {
			return true;
		}

		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'lists ADD COLUMN companyaddress VARCHAR(255)';
