...
* @package SendStudio
*/
class autoresponders_add_autorespondersize extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('autoresponders', 'autorespondersize')) {
			return true;
		}

		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'autoresponders ADD COLUMN autorespondersize INT';
