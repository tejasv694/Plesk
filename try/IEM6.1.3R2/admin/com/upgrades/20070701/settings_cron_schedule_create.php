...
* @package SendStudio
*/
class settings_cron_schedule_create extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		...
		$query = "CREATE TABLE " . SENDSTUDIO_TABLEPREFIX . "settings_cron_schedule (jobtype VARCHAR(20), lastrun INT)";
