...
* @package SendStudio
*/
class queues_queuetype_recipient_idx extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->IndexExists('queues', array('queuetype', 'recipient'))) {
			return true;
		}

		$query = 'create index ' . SENDSTUDIO_TABLEPREFIX . 'queuetype_recipient_idx on ' . SENDSTUDIO_TABLEPREFIX . 'queues(queuetype, recipient)';
