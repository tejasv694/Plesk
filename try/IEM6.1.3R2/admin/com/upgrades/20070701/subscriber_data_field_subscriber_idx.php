...
* @package SendStudio
*/
class subscriber_data_field_subscriber_idx extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->IndexExists('subscribers_data', array('fieldid', 'subscriberid'))) {
			return true;
		}

		$query = 'create index ' . SENDSTUDIO_TABLEPREFIX . 'subscriber_data_field_subscriber_idx on ' . SENDSTUDIO_TABLEPREFIX . 'subscribers_data(fieldid, subscriberid)';
