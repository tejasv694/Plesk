...
* @package SendStudio
*/
class form_pages_change_emailhtml extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if (SENDSTUDIO_DATABASE_TYPE == 'mysql') {
			if (!$this->ColumnExists('form_pages', 'emailhtml')) {
				return false;
			}

			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'form_pages change emailhtml emailhtml longtext';
