...
* @package SendStudio
*/
class stats_autoresponders_add_htmlopens_unique extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		...
		$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'stats_autoresponders add column htmlopens_unique int';
