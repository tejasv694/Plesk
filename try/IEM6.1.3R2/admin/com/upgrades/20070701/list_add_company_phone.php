...
* @package SendStudio
*/
class list_add_company_phone extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('lists', 'companyphone')) {
			return true;
		}

		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'lists ADD COLUMN companyphone VARCHAR(20)';
