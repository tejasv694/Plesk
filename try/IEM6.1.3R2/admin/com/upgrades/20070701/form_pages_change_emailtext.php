...
* @package SendStudio
*/
class form_pages_change_emailtext extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if (SENDSTUDIO_DATABASE_TYPE == 'mysql') {
			if (!$this->ColumnExists('form_pages', 'emailtext')) {
				return false;
			}

			$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'form_pages change emailtext emailtext longtext';
