...
* @package SendStudio
*/
class list_add_company_name extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('lists', 'companyname')) {
			return true;
		}

		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'lists ADD COLUMN companyname VARCHAR(255)';
