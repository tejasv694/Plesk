...
* @package SendStudio
*/
class stats_newsletters_add_textopens_unique extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('stats_newsletters', 'textopens_unique')) {
			return true;
		}

		$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'stats_newsletters add column textopens_unique int';
