...
* @package SendStudio
*/
class users_add_gettingstarted extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('users', 'gettingstarted')) {
			return true;
		}
		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'users ADD gettingstarted INT NOT NULL DEFAULT \'0\'';
