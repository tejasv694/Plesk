...
* @package SendStudio
*/
class lists_add_visiblefields extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('lists', 'visiblefields')) {
			return true;
		}

		if (SENDSTUDIO_DATABASE_TYPE == 'mysql') {
			$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'lists ADD visiblefields TEXT AFTER agreedelete';
		} else {
			$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'lists ADD visiblefields TEXT';
		}
