...
* @package SendStudio
*/
class users_add_segmentadmintype extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('users', 'segmentadmintype')) {
			return true;
		}

		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'users ADD segmentadmintype CHAR(1) DEFAULT NULL';
