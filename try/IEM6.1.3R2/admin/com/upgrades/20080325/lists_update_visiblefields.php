...
* @package SendStudio
*/
class lists_update_visiblefields extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		...
		$query = 'UPDATE ' . SENDSTUDIO_TABLEPREFIX . 'lists SET visiblefields = \'emailaddress,subscribedate,format,status,confirmed\' WHERE visiblefields IS NULL';
