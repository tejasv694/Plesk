...
* @package SendStudio
*/
class stats_newsletters_testmode_add extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('stats_newsletters', 'sendtestmode')) {
			return true;
		}

		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'stats_newsletters ADD COLUMN sendtestmode INT DEFAULT 0';
