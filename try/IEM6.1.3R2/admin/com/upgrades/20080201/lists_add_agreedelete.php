...
* @package SendStudio
*/
class lists_add_agreedelete extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('lists', 'agreedelete')) {
			return true;
		}

		$query = "ALTER TABLE " . SENDSTUDIO_TABLEPREFIX . "lists ADD COLUMN agreedelete CHAR(1)";
