...
* @package SendStudio
*/
class lists_update_settings extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('lists', 'agreedelete') && $this->ColumnExists('lists', 'processbounce')) {
			$query = "UPDATE " . SENDSTUDIO_TABLEPREFIX . "lists SET agreedelete='1', processbounce='1' WHERE bounceserver <> ''";
