...
* @package SendStudio
*/
class users_add_xmltoken extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('users', 'xmltoken')) {
			return true;
		}

		$query = 'alter table ' . SENDSTUDIO_TABLEPREFIX . 'users add column xmltoken char(40)';
