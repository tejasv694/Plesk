...
* @package SendStudio
*/
class stats_newsletters_update_jobid extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('stats_newsletters', 'jobid')) {
			$query = 'update ' . SENDSTUDIO_TABLEPREFIX . 'stats_newsletters set jobid=0 WHERE jobid IS NULL';
