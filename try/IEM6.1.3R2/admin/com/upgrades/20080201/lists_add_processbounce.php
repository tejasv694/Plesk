...
* @package SendStudio
*/
class lists_add_processbounce extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if ($this->ColumnExists('lists', 'processbounce')) {
			return true;
		}

		$query = "ALTER TABLE " . SENDSTUDIO_TABLEPREFIX . "lists ADD COLUMN processbounce CHAR(1)";
